...
class="btn btn-warning" onclick="return confirm('Are you sure you want to delete')"> <span class="glyphicon-info-sign glyphicon"> </span> Delete</a>
</c:if>
<c:if test="${pageContext.request.userPrincipal.name ==post.postUser}">
 <a href="<spring:url value="/editpost1?postId=${post.id}" />"
class="btn btn-warning" onclick="return confirm('Are you sure you want to edit')"> <span class="glyphicon-info-sign glyphicon" > </span> edit	</a>
</c:if>
</td>
</tr>
</c:forEach>
