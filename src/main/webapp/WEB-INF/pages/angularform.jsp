...
<thead>
 ...
 class="btn btn-warning" onclick="return confirm('Are you sure you want to continue')" > <span class="glyphicon-info-sign glyphicon"> </span> Delete</a>
 </c:if>
...
class="btn btn-warning" onclick="return confirm('you are going to edit ')"> <span class="glyphicon-info-sign glyphicon"> </span> edit	</a>
</c:if>
</td>
</tr>
</c:forEach>
