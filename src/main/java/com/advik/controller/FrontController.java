...
@RequestMapping(value="/AngularLogin")
	...
	public String edituserByName(  Model model,Principal principal, User user,BindingResult result)
	{
	...
	public String editUser( @PathVariable("userid") Integer userid,
	        @ModelAttribute("user")@Valid User user,HttpServletRequest request,Map map,Principal p){
